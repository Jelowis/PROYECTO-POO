import { getOpcionesCargo, getOpcionesDepartamento } from "../empleado/combo.js";
      ...
      fetch(this.url)
       ...
       .then((empleados) => {
         ...
         empleados.forEach((empleado) => {
           ...
           let { id, nombre, cedula, Cargo, Departamento, sueldo, estado } = empleado;
           filas += ` <tr>
          <td>${id}</td>
          <td>${nombre}</td>
          <td>${cedula}</td>
         ...
         $btnsEdit.forEach((btn) => {
           btn.addEventListener("click",async (e) => {
             ...
             let { nombre, cargoid, cedula, sueldo, dptoid, estado } = await this.obtenerEmpleado(this.id);
